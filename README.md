...
| :file_folder: [`z7-nano-test-setup`](https://github.com/stnolting/neorv32-setups/tree/main/vivado/cora-z7-test-setup)  | Xilinx Vivado       | [Digilent Cora Z7](https://digilent.com/reference/programmable-logic/cora-z7/start)                              | Xilinx ZynQ 7000 `xc7z007sclg400-1`        | [eivindbergem](https://github.com/eivindbergem) |
